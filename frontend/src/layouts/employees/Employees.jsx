...
function Employees() {
  ...
  const handleTerminateEmployee = async (id) => {
    try {
      await axios.put(`api/employees/${id}/terminate`); // Adjust endpoint if needed
      getEmployees(); // Refresh the table
      getEmployeesStats(); // Update stats
    } catch (error) {
    ...
    <>
      ...
      <div className='app-main-container'>
        ...
        <div className='app-main-right-container'>
          ...
          <div className='table-main-header' style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          {/* Search Bar Positioned Below Add Button */}
